...
// https://code.qt.io/cgit/qt/qtgraphs.git/tree/examples/graphs/2d/hellographs/qml/hellographs/main.qml?h=6.10
// added ApplicationWindow
// in real app, you would want to use opacity instead of hardcoded colors
// so the thing works in both light and dark mode without looking ugly...
import QtQuick
